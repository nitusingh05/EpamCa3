...
public class AppTest {
    ...
    void githubLoginPageTest() throws InterruptedException {
        ...
        Thread.sleep(1000L);
        this.driver.findElement(By.cssSelector("input#login_field")).sendKeys(new CharSequence[]{"ns21709npj@gmail.com"});
        Thread.sleep(1000L);
        this.driver.findElement(By.cssSelector("input#password")).sendKeys(new CharSequence[]{"Malini@88"});
        Thread.sleep(3000L);
